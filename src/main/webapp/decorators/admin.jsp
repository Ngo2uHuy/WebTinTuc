...
<link href="<c:url value='/template/admin/css/style-responsive.css'/>"
	rel="stylesheet" />
<link rel="stylesheet"
	href="<c:url value='/template/admin/css/lightbox.css'/>">
<!-- font CSS -->
<link
...
<!-- font-awesome icons -->
<link rel="stylesheet"
	href="<c:url value='/template/admin/css/font.css'/>" type="text/css" />
<link href="<c:url value='/template/admin/css/font-awesome.css'/>"
	rel="stylesheet">
<!-- //font-awesome icons -->
...
<body>
	<section id="container"> <!-- header --> <%@include
		file="/common/admin/header.jsp"%> <!-- header -->

	<!-- menu --> <%@include file="/common/admin/menu.jsp"%>
	<!-- menu --> <!--main content start--> <section id="main-content">
	<section class="wrapper"> <dec:body /> </section> <!-- footer --> <%@include
		file="/common/admin/footer.jsp"%> <!-- / footer -->
