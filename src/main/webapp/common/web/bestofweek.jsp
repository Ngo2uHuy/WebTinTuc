	...
	<div class="container">
		...
		<div class="owl-carousel owl-theme carousel-1">
			<article class="article">
				<div class="inner">
					<figure>
						<a href="single.html"> <img src="<c:url value='/template/web/images/news/img03.jpg'/>"
							alt="Sample Article">
						</a>
					</figure>
					<div class="padding">
			...
			<article class="article">
				<div class="inner">
					<figure>
						<a href="single.html"> <img src="<c:url value='/template/web/images/news/img16.jpg'/>"
							alt="Sample Article">
						</a>
					</figure>
					<div class="padding">
			...
			<article class="article">
				<div class="inner">
					<figure>
						<a href="single.html"> <img src="<c:url value='/template/web/images/news/img15.jpg'/>"
							alt="Sample Article">
						</a>
					</figure>
					<div class="padding">
			...
			<article class="article">
				<div class="inner">
					<figure>
						<a href="single.html"> <img src="<c:url value='/template/web/images/news/img14.jpg'/>"
							alt="Sample Article">
						</a>
					</figure>
					<div class="padding">
			...
			<article class="article">
				<div class="inner">
					<figure>
						<a href="single.html"> <img src="<c:url value='/template/web/images/news/img01.jpg'/>"
							alt="Sample Article">
						</a>
					</figure>
					<div class="padding">
			...
			<article class="article">
				<div class="inner">
					<figure>
						<a href="single.html"> <img src="<c:url value='/template/web/images/news/img11.jpg'/>"
							alt="Sample Article">
						</a>
					</figure>
					<div class="padding">
