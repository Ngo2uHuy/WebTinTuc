						...
						<div class="col-md-3 col-sm-12 text-right">
							<ul class="nav-icons">
								<c:if test="${not empty USERMODEL}">
									<li><a href="#"><i class="ion-person"></i><div>Wellcome, ${USERMODEL.fullName}</div></a></li>
									<li><a href="<c:url value='/thoat?action=logout'/>"><i class="ion-person"></i><div>Logout</div></a></li>
								</c:if>
								
								<c:if test="${empty USERMODEL}">
									<li><a href="register.html"><i class="ion-person"></i><div>Register</div></a></li>
									<li><a href="<c:url value='/dang-nhap?action=login'/>"><i class="ion-person"></i><div>Login</div></a></li>
								</c:if>
							</ul>
						</div>
					</div>
												...
												<div class="row">
													<article class="article col-md-4 mini">
														<div class="inner">
															<figure>
																<a href="single.html">
																	<img src="<c:url value='/template/web/images/news/img10.jpg'/>" alt="Sample Article">
																</a>
															</figure>
															<div class="padding">
																<div class="detail">
													...
													<article class="article col-md-4 mini">
														<div class="inner">
															<figure>
																<a href="single.html">
																	<img src="<c:url value='/template/web/images/news/img11.jpg'/>" alt="Sample Article">
																</a>
															</figure>
															<div class="padding">
																<div class="detail">
													...
													<article class="article col-md-4 mini">
														<div class="inner">
															<figure>
																<a href="single.html">
																	<img src="<c:url value='/template/web/images/news/img14.jpg'/>" alt="Sample Article">
																</a>
															</figure>
															<div class="padding">
																<div class="detail">
