...
<header class="header fixed-top clearfix">
			...
			<li id="header_inbox_bar" class="dropdown"><a
				...
				<ul class="dropdown-menu extended inbox">
					...
					<li><a href="#"> <span class="photo"><img
								alt="avatar" src="<c:url value='/template/admin/images/3.png'/>"></span> <span class="subject">
								<span class="from">Jonathan Smith</span> <span class="time">Just
									now</span>
						</span> <span class="message"> Hello, this is an example msg. </span>
					</a></li>
					<li><a href="#"> <span class="photo"><img
								alt="avatar" src="<c:url value='/template/admin/images/1.png'/>"></span> <span class="subject">
					...
					<li><a href="#"> <span class="photo"><img
								alt="avatar" src="<c:url value='/template/admin/images/2.png'/>"></span> <span class="subject">
	...
	<div class="top-nav clearfix">
		...
		<ul class="nav pull-right top-menu">
			...
			<li class="dropdown"><a data-toggle="dropdown"
				class="dropdown-toggle" href="#"> <img alt="" src="<c:url value='/template/admin/images/2.png'/>">
					<span class="username">${USERMODEL.fullName}</span> <b class="caret"></b>
			</a>
				<ul class="dropdown-menu extended logout">
					<li><a href="#"><i class=" fa fa-suitcase"></i>Profile</a></li>
					<li><a href="#"><i class="fa fa-cog"></i> Settings</a></li>
					<li><a href="<c:url value='/dang-nhap?action=login'/>"><i class="fa fa-key"></i> Log Out</a></li>
				</ul></li>
